...
#read data of 'data/some_posts.csv' and select  data of 'lat' and 'lon'
data = pd.read_csv('data/some_posts.csv')
data['geometry'] = None
# create  data type of Point
point = lambda x:Point(x['lat'],x['lon'])
...
fp = 'Kruger_posts.shp'
# Save the GeoDataFrame into a new Shapefile called 'Kruger_posts.shp'.
geo.to_file(fp)
# CODE FOR TESTING YOUR SOLUTION
